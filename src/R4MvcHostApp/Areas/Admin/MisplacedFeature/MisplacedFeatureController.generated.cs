...
{
    public partial class MisplacedFeatureController
    {
        [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
        public MisplacedFeatureController()
        {
        }

        [GeneratedCode("R4Mvc", "1.0"), DebuggerNonUserCode]
        protected MisplacedFeatureController(Dummy d)
        {
        }
        ...
        public MisplacedFeatureController Actions => MVC.AdminArea.MisplacedFeature;
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("R4Mvc", "1.0")]
        public readonly string Name = "MisplacedFeature";
        [GeneratedCode("R4Mvc", "1.0")]
        public const string NameConst = "MisplacedFeature";
        [GeneratedCode("R4Mvc", "1.0")]
