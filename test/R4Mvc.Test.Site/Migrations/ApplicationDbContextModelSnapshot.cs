...
using R4Mvc.Test.Site.Models;

namespace R4Mvc.Test.Site.Migrations
{
    [ContextType(typeof(R4Mvc.Test.Site.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("R4Mvc.Test.Site.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("R4Mvc.Test.Site.Models.ApplicationUser", "UserId");
                });
